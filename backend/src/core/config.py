...
class Settings(BaseSettings):
    ...
    POSTGRES_USER: str = getenv_value("POSTGRES_USER", 'postgres')
    POSTGRES_PASSWORD: str = getenv_value("POSTGRES_PASSWORD", 'postgres')
    POSTGRES_DB: str = getenv_value("POSTGRES_DB", 'stanchion_db')
    ...
    FIRST_SUPERUSER_EMAIL: EmailStr = getenv_value("FIRST_SUPERUSER", 'admin@stanchionlabs.inc')
